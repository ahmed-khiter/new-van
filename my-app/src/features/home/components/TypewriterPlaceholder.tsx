...
export default function TypewriterPlaceholder({
  ...
  const safePhrases = useMemo(() => (phrases.length ? phrases : ["explore services"]), [phrases]);
  ...
  }, [deletingSpeedMs, holdMs, isDeleting, phraseIndex, safePhrases, typingSpeedMs, value]);
